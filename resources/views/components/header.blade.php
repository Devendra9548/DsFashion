    ...
    <div class="container-fluid">
        <div class="row py-3">
            <div class="col-1">
                <div class="logo">
                    <a href="/">
                        <img src="/assets/imgs/dsfashion.png" alt="myntra" width="90px">
                    </a>
                </div>
            </div>
                ...
                <div class="cards d-flex align-items-center">
                    ...
                    <div class="cart text-center me-4 position-relative">
                        ...
                        @if(session('cart'))
                            ...
                            <span style="position: absolute;top: -7px;background: red !important;padding: 0px !important;height: 20px;width: 20px;font-size: 12px !important;display: flex;justify-content: center;align-items: center;border-radius: 100px;left: 18px;">
                            {{ count(session('cart')) }}
                            </span>
                            @endif
                        @endif
